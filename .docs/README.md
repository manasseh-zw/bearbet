...
6. [`drakon-api.md`](./drakon-api.md) documents the Drakon authentication, catalogue, launch, and wallet callback contract.
7. [`drakon-v0-findings.md`](./drakon-v0-findings.md) records live V0 evidence, undocumented behavior, and the account-access blocker.
