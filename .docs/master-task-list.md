...
- [x] **A05. Build bonus management.** Create, edit, activate, and deactivate definitions with audited mutations, stable definition codes, and clear rules for existing awards.
